...
defmodule ListOpsTest do
  ...
  test "filter of ndormal list" do
    assert L.filter([2,2,3,4], &odd?/1) == [3]
  end
  ...
  # test "flatten of  lists" do
  #   assert L.flatten([]) == []
  #   assert L.flatten([1]) == [1]
  # end
  # test "flatten of  lol lists" do
  #   assert L.flatten([[1, 2],2]) == [1,2,2]
  # end

  # test "flatten of non-empty lists" do
  #   assert L.flatten([1,2, [2, [4,5,6]]]) == [1,2,3,4,5,6]
  # end
